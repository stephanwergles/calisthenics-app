...
3er-Split (24 Slots, 47 Progressionsstufen) · Satz-Logging mit Wdh./Sekunden/Zusatzgewicht · verdiente Freischaltungen (2× alle Sätze am Ziel) · Technik-Sektionen (Position, Ausführung, Fehler, Leichter/Schwerer, Kreide-Skizzen) · Pausen-Timer mit Auto-Start · Trainings-Session-Timer · Log mit Dauer · JSON-Export/Import.

Seit v1.4: Sätze pro Tag anpassbar (± direkt an der Übung) · erledigte Übungen klappen automatisch zu, die aktive ist hervorgehoben · Hold-Timer für Zeitübungen im Satz-Editor · Pausen-Timer zeitstempelbasiert (übersteht App-Suspend) · Zoom gesperrt · Lösch-Button mit Rückfrage (v1.4.1) · Versionsnummer im Header + In-App-Update-Check mit Neustart-Banner gegen iOS-PWA-Caching (v1.4.2) · Wake Lock: Display bleibt während laufender Session an (v1.5.0) · App-Icon + Favicon + Home-Bildschirm-Titel „Calisthenics" (v1.5.1; seit v1.5.2 Kreide-C statt Strichfigur) · Export-Erinnerung im Log, Einheiten im Log löschbar (v1.6.0) · Lösch-Button mit lokalem Datum + nur bei Bedarf sichtbar (v1.6.3/v1.6.4) · Offected-Farbschema: Orange #FF4D00 auf Schwarz #101010 (v1.7.0/v1.7.1) · Navigation neu: 2 Tabs — Workout mit Split-Wahl inkl. Rotations-Empfehlung, Übungs-/Satz-Zähler und prominentem Start-Button, Activity mit Monatskalender (v1.8.0) · Kalender als Tages-Filter (v1.8.1) · Übungen pro Tag überspringbar, Uneven Pull-ups als Vorstufe vor Archer (v1.9.0) · Button-System mit Varianten, 44px-Touch-Targets, Fokus-Ringe, Badge/Button klar getrennt (v1.10.0) · Split-Empfehlung folgt dem festen Wochenrhythmus So=A / Mo=C / Mi=B statt stumpfer Rotation, Wochentage im Picker sichtbar und in Wochenreihenfolge (v1.11.0–v1.11.2) · Cardio-Einträge (Rad/Lauf) im Activity-Tab inkl. Kalender-Markierung, Warm-up- und Cool-down-Checklisten pro Trainingstag, Export auf version 4 (v1.12.0) · lockeres Cardio als erster Cool-down-Punkt an Tag A und B, direkt aus dem Workout eintragbar (v1.13.0) · Timer-Alarm mit Ton und blinkender Leiste statt Vibration (auf iOS nie unterstützt), Uneven Pull-ups im Tag A vorgezogen, Bizeps-Curls als Stangen-Variante beschrieben (v1.14.0) · Handstand-Balance als eigener Skill-Slot an Tag B (Wall Handstand → Heel Pulls → frei), Band-Muscle-up als Zwischenstufe (v1.15.0) · Übungen dauerhaft pausierbar für Urlaub, fehlendes Gerät oder Verletzung, Export auf version 5, Smoke-Test als `test/smoke.js` im Repo (v1.16.0) · Muscle-up-Weg nach Trainingsfeedback umgebaut: Band-Muscle-up ist die Transition-Übung, Chest-to-Bar-Klimmzüge liefern die fehlende Zughöhe (v1.16.2).
...
- [x] ~~Warm-up-Checkliste pro Tag~~ — erledigt in v1.12.0, inkl. Cool-down/Dehnen
...
4. ~~Cardio-Tracking in der App oder bewusst draußen lassen?~~ **Beantwortet (Aug 2026):** Rad und Lauf ersetzen regelmäßig geplante Einheiten — ohne Erfassung fehlte im Kalender die halbe Trainingswoche. Seit v1.12.0 drin, bewusst minimal (Art, Dauer, Distanz, Höhenmeter; keine Pace, kein GPS, keine Herzfrequenz).
